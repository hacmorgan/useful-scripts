...
alias dat2pro="pwd | sed 's/datasets/processed/g'"
alias pro2dat="pwd | sed 's/processed/datasets/g'"
alias bld2src="pwd | sed 's/build/src/g'"
alias src2bld="pwd | sed 's/src/build/g'"
alias l='ls -l'
alias ll='ls -la'
