...
/* package rpnCalc-1.0 */
#ifndef VERSION_rpnCalc
#define VERSION_rpnCalc "1.0"
#endif /* VERSION_rpnCalc */
#ifndef MIN_VERSION_rpnCalc
#define MIN_VERSION_rpnCalc(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_rpnCalc */
...
#define CURRENT_COMPONENT_ID "rpnCalc-1.0-DhDHs2UkH1u9m7erPLwWEq-rpnCalc"
